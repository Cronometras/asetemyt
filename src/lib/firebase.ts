...
export const translations = {
  es: {
    ...
    videoAvail: '📹 Vídeo',
    // Comparador — parámetros comunes (docs/parametros-comparador-software.md)
    ...
    softwareBadge: 'Software',
    vCloud: 'En la nube',
    vLocal: 'Local (equipo o servidor propio)',
    vHybrid: 'Híbrido',
    vPartial: 'Parcial',
    vSubscription: 'Suscripción',
    vPerpetual: 'Licencia perpetua',
    vFree: 'Gratuito',
    vFreemium: 'Freemium',
    vContact: 'Por contacto',
    vTrialRequest: 'Demo a solicitud',
    vConsultant: 'Consultores',
    vSmb: 'PYME',
    vEnterprise: 'Gran empresa',
    vSmbEnterprise: 'PYME y gran empresa',
    vNotPublished: 'No publicado',
    // Ficha detail labels
    about: 'Acerca de',
  ...
  en: {
    ...
    videoAvail: '📹 Video',
    // Comparador — common parameters (docs/parametros-comparador-software.md)
    ...
    softwareBadge: 'Software',
    vCloud: 'Cloud',
    vLocal: 'Local (device or own server)',
    vHybrid: 'Hybrid',
    vPartial: 'Partial',
    vSubscription: 'Subscription',
    vPerpetual: 'Perpetual license',
    vFree: 'Free',
    vFreemium: 'Freemium',
    vContact: 'Contact for pricing',
    vTrialRequest: 'Demo on request',
    vConsultant: 'Consultants',
    vSmb: 'SMB',
    vEnterprise: 'Enterprise',
    vSmbEnterprise: 'SMB and enterprise',
    vNotPublished: 'Not published',
    // Ficha detail labels
    about: 'About',
